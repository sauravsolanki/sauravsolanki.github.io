...
draft: false
summary: Building real-time intent recognition achieving <500ms latency with 70% accuracy improvement, and implementing Query AutoComplete using Ghosting approach with N-gram models and fine-tuned GPT-2.
